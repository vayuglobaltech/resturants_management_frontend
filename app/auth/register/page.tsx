...
export default function RegisterPage() {
  ...
  const inputCls =
    "w-full px-4 py-3 rounded-xl border border-border/70 bg-background/80 text-foreground shadow-sm placeholder:text-muted-foreground text-sm outline-none transition-all focus:border-[var(--primary)] focus:ring-4 focus:ring-[var(--primary)]/15";
  const labelCls = "text-sm font-medium text-muted-foreground";

  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-background text-foreground relative overflow-scroll transition-colors duration-300">
      {/* bg orbs */}
