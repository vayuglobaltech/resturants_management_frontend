...
> = {
  ...
  payments: [
    ...
    { label: "Process Payment", icon: CheckCircle, href: "/dashboard/payments/process" },
  ...
  reports: [
    ...
    { label: "Employee Performance", icon: Users, href: "/dashboard/reports/employee" },
  ],
};
      ...
      {!collapsed ? (
        ...
        <>
            ...
            {filteredItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    "flex items-center gap-2.5 rounded-lg px-2.5 py-2 transition-all duration-200 group relative",
                    isActive
          ...
          {(selectedFeature === "orders" || selectedFeature === "tables") &&
            ...
            <div className="flex-1 overflow-y-auto px-2.5 pb-3 scrollbar-none">
